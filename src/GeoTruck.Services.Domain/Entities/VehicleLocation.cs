...
public class VehicleLocation : Entity<VehicleLocation>
{
    ...
    public VehicleLocation(Vehicle vehicle, decimal latitude, decimal longitude, long positionId, DateTime date, DateTime dateUTC)
    {
        Vehicle = vehicle;
    ...
    public static VehicleLocation Create(Vehicle vehicle, decimal latitude, decimal longitude, long positionId, DateTime date, DateTime dateUTC)
    {
